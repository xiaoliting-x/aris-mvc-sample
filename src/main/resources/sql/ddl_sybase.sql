...
--go
-- deffault user
insert into t_user values ("U0001", "test1", "password", "R0001", "test1@mizuho-sc.com","s1","n1","text","df",getdate(), null)
go
insert into t_user values ("U0002", "test2", "password", "R0002", "test2@mizuho-sc.com","s2","n2","text","df",getdate(), null)
go
-- ====================================================
